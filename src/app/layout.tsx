...
export const metadata: Metadata = {
  ...
  description: "Discover the finest selection of vintage vinyl records and professional turntables. Trusted by DJs, collectors, and audiophiles worldwide with expert curation and quality guarantee.",
  keywords: "vinyl records, turntables, DJ equipment, audiophile, music collection, vintage records, professional audio",
  metadataBase: new URL("https://vinylvibe.com"),
  alternates: {
    canonical: "https://vinylvibe.com"
  },
  openGraph: {
    title: "VinylVibe - Premium Vinyl Records & Turntables",
    description: "Discover the finest selection of vintage vinyl records and professional turntables. Trusted by DJs, collectors, and audiophiles worldwide.",
